...
def ingest_docs():
    loader = ReadTheDocsLoader(
        "/home/roland-szogi/Documents/langchain/documentation-helper/langchain-docs/api.python.langchain.com/en/latest"
    )
...
def ingest_docs2() -> None:
    ...
    langchain_documents_base_urls2 = ["https://firecrawl.dev"]
